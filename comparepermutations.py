# 11-92 Listing 10-9: comparepermutations.py
...
def classify(a):
    '''Classify a list as on of the six permutations'''
...
def run_test(perm, runs):
    ...
    # permutation_tally list keeps track of each permuatation pattern
    ...
    for i in range(runs):           # Run runs times
        ...
        working = original[:]
        # Permute the list with the permutation alogrithm
        perm(working)
