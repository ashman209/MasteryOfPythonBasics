# 8-70 Listing 7.18: squarerootcomparison.py
from math import fabs, sqrt
# Consider two floating-point numbers equal the difference between them is very small.
...
def square_root(val):
    ...
    while diff > 0.00000001 or diff < -0.00000001:
        ...
        diff = root * root - val               # How far off is our current root?
    return root
